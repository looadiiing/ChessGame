...
def select_piece(G, ABS, ORD):
    ...
    store_valid_square(G, ABS, ORD)
    PIECE_SQUARE = (ABS, ORD)
    print(is_in_check(G))
#    for VALID_SQU in G.validSquares:
#        G.grid[VALID_SQU[0]][VALID_SQU[1]] = what_is_piece(G, G.selectedSquare[0], G.selectedSquare[1])
#        delete_piece(G, ABS, ORD)
#        if is_in_check(G):
